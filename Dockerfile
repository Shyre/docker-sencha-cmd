...
http://cdn.sencha.com/cmd/6.5.0.180/SenchaCmd-6.5.0.180-linux-amd64.sh.zip && \

RUN wget http://cdn.sencha.com/cmd/6.5.0.180/no-jre/SenchaCmd-6.5.0.180-linux-amd64.sh.zip -O senchacmd.zip && unzip senchacmd.zip && rm senchacmd.zip && chmod +x SenchaCmd-6.2.0.103-linux-amd64.sh
